		...
		<div class="nav-header">
			<a href="index.html" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">Sofmis</h2>
					<span class="brand-sub-title">rol</span>
				</div>
			</a>
				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="project-page.html">Compras</a></li>
							<li><a href="contacts.html">Inventario</a></li>
							<li><a href="kanban.html">Reportes</a></li>
							<li><a href="calendar-page.html">Usuarios</a></li>
							<li><a href="message.html">Correos</a></li>
						</ul>
								...
								<div class="row m-b-30">
									...
									<div class="col-md-7 col-xxl-12">
										<div class="new-arrival-content position-relative">
											<h4><a href="ecom-product-detail.html">Camiseta oscura con escote en V para mujer</a></h4>
											<div class="comment-review star-rating">
												<p class="price">$320.00</p>
											</div>
											<p>Disponibilidad: <span class="item"> En stock <i class="fa fa-check-circle text-success"></i></span></p>
											<p>Código de producto: <span class="item">0405689</span> </p>
											<p>Marca: <span class="item">Lee</span></p>
											<p class="text-content">Hay muchas variaciones de los pasajes de Lorem Ipsum disponibles, pero la mayoría ha sufrido alteraciones de alguna forma, ya sea por inserción de humor o palabras aleatorias.</p>
										</div>
									</div>
								</div>
							</div>
