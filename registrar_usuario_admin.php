...
if (isset($_SESSION['usuario_id'])) {
    ...
    // Redirigir al dashboard correspondiente según el 
}
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h4 class="text-center mb-4">Registra un nuevo usuario</h4>
                                    ...
                                    <br><br>
                                    <center><a href="usuarios.php"><button class="btn btn-primary btn-block">Volver</button></a></center>
                                </div>
                            </div>
                        </div>
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO usuarios (nombre_usuario, correo_electronico, contrasena, rol, cuenta_habilitada) VALUES ('$nombre_usuario', '$correo_electronico', '$contrasena_encriptada', '$rol', 1)";
