											...
											<div class="card-header border-0 flex-wrap">
												...
												<div class="d-flex align-items-center project-tab mb-2">
													<div class="card-tabs mt-3 mt-sm-0 mb-3 ">
														<ul class="nav n	av-tabs" role="tablist">
															<li class="nav-item">
											...
											<div class="card-body">
												<div class="d-flex justify-content-between align-items-center flex-wrap">
													<div class="d-flex">
														...
														<div class="ms-3">
															<h4 class="fs-24 font-w700 ">10</h4>
															<span class="fs-16 font-w400 d-block">Total de ventas</span>
														</div>
													</div>
													<div class="d-flex">
														<div class="d-flex me-5">
															...
															<div class="ms-3">
																<h4 class="fs-24 font-w700 ">56</h4>
																<span class="fs-16 font-w400 d-block">Clientes</span>
															</div>
														</div>
														<div class="d-flex">
															<div class="mt-2">
															...
															<div class="ms-3">
																<h4 class="fs-24 font-w700 ">19</h4>
																<span class="fs-16 font-w400 d-block">usuarios</span>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="col-xl-12">
										<div class="card">
											<div class="card-header border-0 pb-0">
												<h4 class="fs-20 font-w700 mb-0">Nivel de las ventas</h4>
												<div class="dropdown ">
													<div class="btn-link" data-bs-toggle="dropdown">
														<svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
															<circle cx="12.4999" cy="3.5" r="2.5" fill="#A5A5A5"></circle>
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="row">
											...
											// Consulta SQL para obtener el total de clientes de hoy
											$queryToday = "SELECT COUNT(*) AS total_clientes FROM clientes WHERE DATE(fecha_creacion) = CURDATE()";
											$resultToday = $conexion->query($queryToday);
											$rowToday = $resultToday->fetch_assoc();
											$totalClientesToday = $rowToday['total_clientes'];

											// Consulta SQL para obtener el total de clientes de ayer
											$queryYesterday = "SELECT COUNT(*) AS total_clientes FROM clientes WHERE DATE(fecha_creacion) = DATE_SUB(CURDATE(), INTERVAL 1 DAY)";
											$resultYesterday = $conexion->query($queryYesterday);
											$rowYesterday = $resultYesterday->fetch_assoc();
											$totalClientesYesterday = $rowYesterday['total_clientes'];

											// Calcular la diferencia y el porcentaje de nuevos clientes
											$diferenciaClientes = $totalClientesToday - $totalClientesYesterday;
											if ($totalClientesYesterday > 0) {
												$porcentajeNuevosClientes = ($diferenciaClientes / $totalClientesYesterday) * 100;
											} else {
												$porcentajeNuevosClientes = 0; // O cualquier otro valor predeterminado
											}

											$metaMensual = 100;
											$clientesFaltantes = $metaMensual - $totalClientesToday;

											// Calcular el progreso hacia la meta mensual de clientes nuevos
											$porcentajeProgreso = ($totalClientesToday / $metaMensual) * 100;
											?>
											...
											<div class="col-xl-6 col-sm-6">
												<div class="card">
													<div class="card-body d-flex px-4 pb-0 justify-content-between">
														<div>
															<h4 class="fs-18 font-w600 mb-4 text-nowrap">Total Clientes</h4>
															<div class="d-flex align-items-center">
																<h2 class="fs-32 font-w700 mb-0"><?php echo $totalClientesToday; ?></h2>
																<span class="d-block ms-4">
																	...
																	<small class="d-block fs-16 font-w400 text-success"><?php echo round($porcentajeNuevosClientes, 2); ?>%</small>
																</span>
															</div>
														</div>
											...
											<div class="col-xl-6 col-sm-6">
												<div class="card">
													<div class="card-body px-4 pb-0">
														<h4 class="fs-18 font-w600 mb-5 text-nowrap">Total Clientes</h4>
														<div class="progress default-progress">
															<div class="progress-bar bg-gradient1 progress-animated" style="width: <?php echo $porcentajeProgreso; ?>%; height:10px;" role="progressbar">
																<span class="sr-only"><?php echo $porcentajeProgreso; ?>% Completado</span>
															</div>
														</div>
														<div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
															<span><?php echo $clientesFaltantes; ?> Faltan para el objetivo</span>
															<h4 class="mb-0"><?php echo $totalClientesToday; ?></h4>
														</div>
													</div>
												</div>
											</div>
											...
											$queryThisMonth = "SELECT COUNT(*) AS total_clientes FROM clientes WHERE MONTH(fecha_creacion) = MONTH(CURDATE()) AND YEAR(fecha_creacion) = YEAR(CURDATE())";
											$resultThisMonth = $conexion->query($queryThisMonth);
											$rowThisMonth = $resultThisMonth->fetch_assoc();
											$totalClientesThisMonth = $rowThisMonth['total_clientes'];

											// Obtener el total de clientes del mes pasado
											$queryLastMonth = "SELECT COUNT(*) AS total_clientes FROM clientes WHERE MONTH(fecha_creacion) = MONTH(CURDATE() - INTERVAL 1 MONTH) AND YEAR(fecha_creacion) = YEAR(CURDATE() - INTERVAL 1 MONTH)";
											$resultLastMonth = $conexion->query($queryLastMonth);
											$rowLastMonth = $resultLastMonth->fetch_assoc();
											$totalClientesLastMonth = $rowLastMonth['total_clientes'];

											// Calcular la diferencia en porcentaje
											if ($totalClientesLastMonth > 0) {
												$porcentajeDiferencia = (($totalClientesThisMonth - $totalClientesLastMonth) / $totalClientesLastMonth) * 100;
											} else {
												$porcentajeDiferencia = 0; // Evitar división por cero
											}

											// Redondear el valor del porcentaje y limitarlo a un rango de 1 a 100
											$porcentajeDiferencia = min(max(round($porcentajeDiferencia), 1), 100);
											?>
											<div class="col-xl-6 col-sm-6">
												<div class="card">
													<div class="card-body d-flex px-4 justify-content-between">
														<div>
															<div class="">
																<h2 class="fs-32 font-w700"><?php echo $totalClientesThisMonth; ?></h2>
																<span class="fs-18 font-w500 d-block">Total Clientes</span>
																<span class="d-block fs-16 font-w400">
																	<?php if ($porcentajeDiferencia < 0) : ?>
																		<small class="text-danger"><?php echo abs($porcentajeDiferencia); ?>% disminuyó</small>
																	<?php elseif ($porcentajeDiferencia > 0) : ?>
																		<small class="text-success"><?php echo $porcentajeDiferencia; ?>% incrementó</small>
																	<?php else : ?>
											...
											$queryThisMonth = "SELECT COUNT(*) AS total_ventas FROM ventas WHERE MONTH(fecha_venta) = MONTH(CURDATE()) AND YEAR(fecha_venta) = YEAR(CURDATE())";
											$resultThisMonth = $conexion->query($queryThisMonth);
											$rowThisMonth = $resultThisMonth->fetch_assoc();
											$totalVentasThisMonth = $rowThisMonth['total_ventas'];

											// Obtener el total de ventas del mes pasado
											$queryLastMonth = "SELECT COUNT(*) AS total_ventas FROM ventas WHERE MONTH(fecha_venta) = MONTH(CURDATE() - INTERVAL 1 MONTH) AND YEAR(fecha_venta) = YEAR(CURDATE() - INTERVAL 1 MONTH)";
											$resultLastMonth = $conexion->query($queryLastMonth);
											$rowLastMonth = $resultLastMonth->fetch_assoc();
											$totalVentasLastMonth = $rowLastMonth['total_ventas'];

											// Calcular la diferencia en porcentaje
											if ($totalVentasLastMonth > 0) {
												$porcentajeDiferencia = (($totalVentasThisMonth - $totalVentasLastMonth) / $totalVentasLastMonth) * 100;
											} else {
												$porcentajeDiferencia = 0; // Evitar división por cero
											}
											...
											<div class="col-xl-6 col-sm-6">
												<div class="card">
													<div class="card-body d-flex px-4 justify-content-between">
														<div>
															<div class="">
																<h2 class="fs-32 font-w700"><?php echo $totalVentasThisMonth; ?></h2>
																<span class="fs-18 font-w500 d-block">Nuevas Ventas</span>
																<span class="d-block fs-16 font-w400">
																	<?php if ($porcentajeDiferencia < 0) : ?>
																		<small class="text-danger"><?php echo abs($porcentajeDiferencia); ?>% disminución</small>
																	<?php elseif ($porcentajeDiferencia > 0) : ?>
																		<small class="text-success"><?php echo $porcentajeDiferencia; ?>% aumento</small>
																	<?php else : ?>
																		<small class="text-muted">Sin cambios</small>
																	<?php endif; ?>
																	respecto al mes pasado
									...
									<?php
									// Establecer la meta de ventas al mes
									$metaVentasMes = 500;
									...
									$progresoVentas = ($totalVentasThisMonth / $metaVentasMes) * 100;
									?>
												...
												<div class="row">
													<div class="col-xl-6 col-sm-6">
														<div class=" owl-carousel card-slider">
															<div class="items">
																<h4 class="fs-20 font-w700 mb-4">Meta de Ventas</h4>
																<span class="fs-14 font-w400">Nuestra meta para este mes es alcanzar <?php echo $metaVentasMes; ?> ventas. ¡Trabajemos juntos para lograrlo!</span>
															</div>
															<div class="items">
																<h4 class="fs-20 font-w700 mb-4">Meta de Ventas</h4>
																<span class="fs-14 font-w400">Nuestra meta para este mes es alcanzar <?php echo $metaVentasMes; ?> ventas. ¡Trabajemos juntos para lograrlo!</span>
													...
													<div class="col-xl-6 redial col-sm-6">
														<div id="redial"></div>
														<span class="text-center d-block fs-18 font-w600">En progreso <small class="text-success"><?php echo round($progresoVentas, 2); ?>%</small></span>
													</div>
												</div>
											</div>
										</div>
									...
									<script>
										var redial = function() {
											var options = {
												series: [<?php echo $progresoVentas; ?>], // El progreso de las ventas se pasa como el valor de la serie
												chart: {
													type: 'radialBar',
													offsetY: 0,
													height: 350,
												...
												labels: ['Progreso de ventas'], // Etiqueta para la barra de progreso
											};
									...
									<?php
									// Consulta SQL para obtener la cantidad de productos disponibles
									$queryDisponibles = "SELECT COUNT(*) AS cantidad_disponibles FROM productos WHERE stock > 6";
									$resultDisponibles = $conexion->query($queryDisponibles);
									$rowDisponibles = $resultDisponibles->fetch_assoc();
									$cantidadDisponibles = $rowDisponibles['cantidad_disponibles'];

									// Consulta SQL para obtener la cantidad de productos en alerta
									$queryAlerta = "SELECT COUNT(*) AS cantidad_alerta FROM productos WHERE stock <= 5 AND stock > 0";
									$resultAlerta = $conexion->query($queryAlerta);
									$rowAlerta = $resultAlerta->fetch_assoc();
									$cantidadAlerta = $rowAlerta['cantidad_alerta'];

									// Consulta SQL para obtener la cantidad de productos agotados
									$queryAgotados = "SELECT COUNT(*) AS cantidad_agotados FROM productos WHERE stock = 0";
									$resultAgotados = $conexion->query($queryAgotados);
									$rowAgotados = $resultAgotados->fetch_assoc();
									$cantidadAgotados = $rowAgotados['cantidad_agotados'];
									?>
											...
											<div class="col-xl-6 col-xxl-12 col-sm-6">
												<div class="card">
													<div class="card-header border-0">
														<div>
															<h4 class="fs-20 font-w700">Estado de Productos</h4>
															<span class="fs-14 font-w400 d-block">Cantidad de productos disponibles, en alerta y agotados</span>
														</div>
													</div>
													<div class="card-body">
														...
														<div>
															<div class="d-flex align-items-center justify-content-between mb-4">
																<span class="fs-18 font-w500">
																	...
																	Productos Disponibles (<?php echo round(($cantidadDisponibles / ($cantidadDisponibles + $cantidadAlerta + $cantidadAgotados)) * 100); ?>%)
																</span>
																<span class="fs-18 font-w600"><?php echo $cantidadDisponibles; ?></span>
															</div>
															<div class="d-flex align-items-center justify-content-between mb-4">
																<span class="fs-18 font-w500">
																	<svg class="me-3" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
																	...
																	Productos en Alerta (<?php echo round(($cantidadAlerta / ($cantidadDisponibles + $cantidadAlerta + $cantidadAgotados)) * 100); ?>%)
																</span>
																<span class="fs-18 font-w600"><?php echo $cantidadAlerta; ?></span>
															</div>
															<div class="d-flex align-items-center justify-content-between mb-4">
																<span class="fs-18 font-w500">
																	<svg class="me-3" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
																	...
																	Productos Agotados (<?php echo round(($cantidadAgotados / ($cantidadDisponibles + $cantidadAlerta + $cantidadAgotados)) * 100); ?>%)
																</span>
																<span class="fs-18 font-w600"><?php echo $cantidadAgotados; ?></span>
															</div>
														</div>
									...
									<script>
										var emailchart = function() {
											var options = {
												series: [<?php echo $cantidadDisponibles; ?>, <?php echo $cantidadAlerta; ?>, <?php echo $cantidadAgotados; ?>],
												chart: {
													type: 'donut',
													height: 300,
												},
