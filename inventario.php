            ...
            <div class="container-fluid">
                                ...
                                <form action="agregar_producto.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="nombre_producto" placeholder="Nombre producto" required>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select id="inputState" class="default-select form-control wide" name="categoria" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="file" class="form-file-input form-control" name="imagen" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Proveedor</label>
                                            <select id="inputState" class="default-select form-control wide" name="proveedor_id" required>
                                                <option selected disabled>Seleccionar...</option>
                                                <?php
                                                // Consulta SQL para seleccionar proveedores activos
                                                $sql = "SELECT id, nombre FROM Proveedores WHERE estado = 'Activo'";
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <img id="imagen_previa" src="" alt="" style="max-width: 100%; max-height: 200px;">
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary">Registrar</button>
                                    <button type="reset" class="btn light btn-primary">Limpiar</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            if ($resultado->num_rows > 0) {
                                                ...
                                                // Si no se encontraron productos activos, mostrar una fila indicando que no hay datos
                                                echo '<tr>';
                                                echo '<td colspan="9">No hay productos activos disponibles</td>';
                                                echo '</tr>';
                                            }
                                            ?>
                                        </tbody>
                            ...
                            <div class="modal-body">
                                <form action="actualizar_producto.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Categoría</label>
                                            <select id="categoria_producto" name="categoria" class="default-select form-control wide" required>
                                                <option value="Utensilios">Utensilios</option>
                                                <option value="Soportes">Soportes</option>
                                                <option value="Archivo">Archivo</option>
                                                <option value="Fijación">Fijación</option>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" id="marca_producto" name="marca" class="form-control" placeholder="Marca" required>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" id="stock_actual" class="form-control" placeholder="Stock Actual" readonly>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label for="accion_stock" class="form-label">Acción de Stock</label>
                                            <select id="accion_stock" name="accion_stock" class="default-select form-control wide" required>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="file" id="imagen_nueva_producto" class="form-file-input form-control" name="imagen_nueva">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">Proveedor</label>
                                            <select id="proveedor_producto" name="proveedor" class="default-select form-control wide" required>
                                                <?php
                                                // Consulta SQL para seleccionar todos los proveedores
                                                $sql_proveedores = "SELECT * FROM Proveedores WHERE estado = 'Activo'";
                                                ...
                                                if ($resultado_proveedores->num_rows > 0) {
                                                    ...
                                                    // Si no se encontraron proveedores, mostrar un mensaje indicando que no hay datos
                                                    echo '<option value="">No hay proveedores disponibles</option>';
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <img id="imagen_producto_actual" class="" src="" alt="Imagen del producto" height="300px">
                                        </div>
                                    </div>
                ...
                <script>
                    $(document).on("click", ".edit-btn", function() {
                        ...
                        $("#estado_producto").val(estado);

                        // Mostrar la imagen actual del producto en el modal
                        $("#imagen_producto_actual").attr("src", imagen);


                        // Limpiar el campo de entrada de archivo para evitar cargar el archivo anterior
                        $("#imagen_nueva_producto").val("");

                        // Mostrar la cantidad de stock actual
                        $("#stock_actual").val(stock);

                        // Establecer valores predeterminados para la acción de stock y la cantidad de stock
                        $("#accion_stock").val("agregar");
