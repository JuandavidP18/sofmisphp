                                ...
                                <div class="row">
                                    <div class="col-xl-9">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <form action="reporte_usuarios.php" method="GET">
                                                        <div class="col-xl-4 mb-3">
                                                            <div class="example">
                                                                <p class="mb-1">Fechas para la Descarga</p>
                                                                <input class="form-control input-daterange-datepicker" type="text" name="daterange" id="daterange" value="01/01/2024 - 01/31/2024">
                                                            </div>
                                                        </div>
                                                        <div class="buton-derecha">
                                                            <button type="submit" class="btn btn-rounded btn-primary" name="submit"><span class="btn-icon-start text-primary"><i class="fa fa-download color-primary"></i></span>Descargar</button>
                                                        </div>
                                                    </form>
                                ...
                                <div class="row">
                                    <div class="col-xl-9">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <form action="reporte_productos.php" method="GET">
                                                        <div class="col-xl-4 mb-3">
                                                            <div class="example">
                                                                <p class="mb-1">Fechas para la Descarga</p>
                                                                <input class="form-control input-daterange-datepicker" type="text" name="daterange" id="daterange" value="01/01/2024 - 01/31/2024">
                                ...
                                <div class="row">
                                    <div class="col-xl-9">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <form action="reporte_proveedores.php" method="GET">
                                                        <div class="col-xl-4 mb-3">
                                                            <div class="example">
                                                                <p class="mb-1">Fechas para la Descarga</p>
                                                                <input class="form-control input-daterange-datepicker" type="text" name="daterange" id="daterange" value="01/01/2024 - 01/31/2024">
                                ...
                                <div class="row">
                                    <div class="col-xl-9">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <form action="reporte_clientes.php" method="GET">
                                                        <div class="col-xl-4 mb-3">
                                                            <div class="example">
                                                                <p class="mb-1">Fechas para la Descarga</p>
                                                                <input class="form-control input-daterange-datepicker" type="text" name="daterange" id="daterange" value="01/01/2024 - 01/31/2024">
